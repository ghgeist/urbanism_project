...
"""
This script is designed to run in a local instance of streamlit against a local database.
Because the db is held in memory, the app is slow to return results. Is designed to call the 'walkability_local.py' script
"""
